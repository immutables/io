...
public interface SqlAccessor {
	...
	public @interface Single {
		 ...
		 * explicitly declare that zero rows is not an error and we can bind to any type supprting
	 ...
	 * The presense of this parameter will enable batch execution mode. Result sets are not supported
	 ...
	 * Otherwise all params will have synthetic names like 'arg0', 'arg1' etc.
	 */
	@Retention(RetentionPolicy.RUNTIME)
	@Target(ElementType.PARAMETER)
...
/*
  public Control control();
	...
	public interface TransactionControl extends AutoCloseable {
