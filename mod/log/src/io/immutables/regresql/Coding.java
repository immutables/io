...
final class Coding {
	...
	static final class ResultSetIn implements In {
		...
		public long takeLong() throws IOException {
			...
			case STRING: l = Long.valueOf((String)values[atColumn]); break;
		...
		public int takeInt() throws IOException {
			...
			case STRING: i = Integer.valueOf((String)values[atColumn]); break;
		...
		public double takeDouble() throws IOException {
			...
			case STRING: d = Double.valueOf((String)values[atColumn]); break;
		...
		public boolean takeBoolean() throws IOException {
			...
			case STRING: b = Boolean.valueOf((String)values[atColumn]); break;
	...
	static class SingleRowDecoder extends Codec<Object> {
		...
		SingleRowDecoder(Codec<Object> codec, Single single) {
			this.codec = codec;
			this.single = single;
		}
	...
	static class ColumnExtractor extends Codec<Object> {
		...
		ColumnExtractor(Codec<Object> codec, Column column) {
			this.codec = codec;
			this.column = column;
		}
